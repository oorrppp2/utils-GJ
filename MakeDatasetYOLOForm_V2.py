...
ID_cnt_train = np.zeros(11)
ID_cnt_valid = np.zeros(11)
# print("ID_cnt :", ID_cnt)
classes = [
    "bed",
    "cabinet",
...
for range_index in range(4):
    ...
    if (data[0] == 'SUNRGBDMeta'):
        ...
        푸train_s = path_tail + "pose_yolo_train_v2.txt"
        valid_s = path_tail + "pose_yolo_valid_v2.txt"
        ...
        for ele in sample_size:
            ...
            img_s = path_tail+"pose_yolo_v2/" + str(ele) + ".tiff"
            img_s_valid = path_tail+"pose_yolo_valid_v2/" + str(ele) + ".tiff"

            txt_s = path_tail+"pose_yolo_v2/" + str(ele) + ".txt"
            txt_s_valid = path_tail+"pose_yolo_valid_v2/" + str(ele) + ".txt"
            ...
            for groundtruth3DBB in data[1][0][image_index][1]:
                for items in groundtruth3DBB:
                    ...
                    label = items[3][0]
                    if label in classes:
                        if label == "cabinet" or label == "kitchen_cabinet" or label == "file_cabinet" or label == "night_stand":
                            label = "drawer"
                            pass
                    ...
                    if max_size < 1685 and random_arr[image_index] == 1:
            ...
            if txt != "":
                if max_size < 1685 and random_arr[image_index] == 1:
                    ...
                    valid_txt += "data/pose_yolo_valid_v2/" + str(ele) + ".tiff" + "\n"
                    pass
                else:
                    ...
                    train_txt += "data/pose_yolo_v2/" + str(ele) + ".tiff" + "\n"
                    pass
                # print(txt)
                # print("==================================")
                pass
        ...
        print("Images : ", imgs)
        print("Images train : ", imgs_train)
        print("Images valid : ", imgs_valid)
