...
for range_index in range(4):
    ...
    if (data[0] == 'SUNRGBDMeta'):
        ...
        train_txt = ""
        valid_txt = ""
        train_s = path_tail + "/pose_yolo_endtable.txt"
        index = 0
        ...
        for ele in sample_size:
            ...
            # img_s = path_tail+"pose_yolo_endtable/" + str(ele) + ".tiff"

            # txt_s = path_tail+"pose_yolo_endtable/" + str(ele) + ".txt"
            ...
            for groundtruth3DBB in data[1][0][image_index][1]:
                for items in groundtruth3DBB:
                    ...
                    # if t_re == 0 or t_im == 0:
                    #     print("r_re : ", t_re, "\t / t_im : ", t_im)
                    #     pass

                    print("radius : ", t_re*t_re+t_im*t_im)
                    t_re = (t_re+1)/2
                    t_im = (t_im+1)/2
            ...
            #     train_txt += "data/pose_yolo_endtable/" + str(ele) + ".tiff" + "\n"
            #     pass
            # pass
