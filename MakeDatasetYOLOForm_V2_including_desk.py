...
for range_index in range(4):
    ...
    if (data[0] == 'SUNRGBDMeta'):
        ...
        train_txt = ""
        valid_txt = ""
        cls_s = path_tail + "/pose_yolo_v3.names"
        train_s = path_tail + "/pose_yolo_train_v3.txt"
        valid_s = path_tail + "/pose_yolo_valid_v3.txt"
        index = 0
        ...
        for ele in sample_size:
            ...
            img_s = path_tail+"pose_yolo_train_v3/" + str(ele) + ".tiff"
            img_s_valid = path_tail+"pose_yolo_valid_v3/" + str(ele) + ".tiff"

            txt_s = path_tail+"pose_yolo_train_v3/" + str(ele) + ".txt"
            txt_s_valid = path_tail+"pose_yolo_valid_v3/" + str(ele) + ".txt"
            ...
            if txt != "":
                if max_size < 1775 and random_arr[image_index] == 1:
                    max_size += 1
                    ...
                    valid_txt += "data/pose_yolo_valid_v3/" + str(ele) + ".tiff" + "\n"
                    pass
                else:
                    ...
                    train_txt += "data/pose_yolo_train_v3/" + str(ele) + ".tiff" + "\n"
                    pass
                pass
